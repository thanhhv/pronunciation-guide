...
3. The **men** worked all day.
4. My dog is my favorite **pet**.
...
Câu ví dụ:
1. She ate an **apple** after lunch.
2. Tom **and** Jerry are friends.
3. Can you **add** your name here?
...
2. The old **man** smiled at us.
3. The **cat** sat on the mat.
4. She wore a **hat** in the sun.
5. Let's check the **map** before we go.
...
1. The bad **man** sat on the **bed** and ate an **apple**.
2. Her **pet** cat wears a **red** **hat**.
3. **Ten** **men** sat on the **mat** by the **pen**.
4. She **set** the **map** flat on the **bench**.
5. **Pat** got **mad** when his **pet** chewed the **bed** sheets.
